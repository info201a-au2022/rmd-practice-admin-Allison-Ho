...
## Covid Report
I write a paragraph here. Damn it! I will highlight that the total number of US cases is `r get_total_cases()`. And, the total number of US deaths is `r get_total_deaths()`. 
